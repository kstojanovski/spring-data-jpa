package com.acme.spring_data_entityless_fetching.carentityless.jpaentitymapping;
...
@Testcontainers
@DataJpaTest
@Import(CarJpaEntityMappingRepository.class)
public class CarDataJpaTest {
   ...
   @Autowired
   CarJpaEntityMappingRepository carJpaEntityMappingRepository;

   @Test
   void testGetCarsAfterYearsNamed() {
      // Act
      List<CarFetcherModel> carsAfterYear = carJpaEntityMappingRepository.findCarsAfterYearsNamed(1980);
   ...
   void testGetCarsAfterYearsNative() {
      // Act
      List<CarFetcherModel> carsAfterYear = carJpaEntityMappingRepository.findCarsAfterYearsNative(1980);
